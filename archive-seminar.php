...
?>
	<article class="contents">
		<div class="cmn-visual"><div>
			<h1 class="cmn-visual__txt1">セミナー</h1>
		</div></div>
...
?>
				<article class="seminar-items__item"<?php echo $i >= $perpage ? ' style="display: none;"' : ''; ?>>
					<div class="seminar-items__item__header">
						<div class="seminar-items__item__tag"><?php echo $category; ?></div>
						<div class="seminar-items__item__date"><?php echo get_post_meta( $post->ID, 'seminar_date_time', true ); ?></div>
					</div>
					<p class="seminar-items__item__title"><?php the_title(); ?></p>
					<p class="seminar-items__item__excerpt"><?php echo get_post_meta( $post->ID, 'seminar_archive_text', true ); ?></p>
					<div class="seminar-items__item__btn"><a href="<?php the_permalink(); ?>" class="mod-btn2"><span>View More</span></a></div>
				</article>
<?php
		$i++;
	}
